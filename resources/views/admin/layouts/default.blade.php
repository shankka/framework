...
<head>
  ...
  <link href="{{ asset('assets/metronic/css/skins/header/base/light.css') }}" rel="stylesheet" type="text/css"/>
  <link href="{{ asset('assets/metronic/css/skins/header/menu/light.css') }}" rel="stylesheet" type="text/css"/>
